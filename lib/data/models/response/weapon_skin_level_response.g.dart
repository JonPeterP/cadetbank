...
_$WeaponSkinLevelResponseImpl _$$WeaponSkinLevelResponseImplFromJson(
...
Map<String, dynamic> _$$WeaponSkinLevelResponseImplToJson(
        _$WeaponSkinLevelResponseImpl instance) =>
    <String, dynamic>{
      'uuid': instance.uuid,
