                        ...
                        if (displayCard != null)
                          GestureDetector(
                            onTap: () async {
                              ...
                              if (chosenCard != null) {
                                context.read<CollectionCubit>().selectPlayerCard(chosenCard);
                              }
                            },
                            child: Container(
                              height: 180,
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(Dimens.s8),
                                border: Border.all(
                                  color: selectedPlayerCard != null ? Colors.green : Colors.grey[700]!,
                                  width: selectedPlayerCard != null ? 2 : 1,
                                ),
                                boxShadow: selectedPlayerCard != null
                                    ? [BoxShadow(color: Colors.green.withOpacity(0.5), offset: const Offset(0, 2), blurRadius: 6)]
                                    : [],
                              ),
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  final chosenSpray = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => SprayDisplayScreen(sprays: sprays),
                                    ),
                                  );
                                  if (chosenSpray != null) {
                                    context.read<CollectionCubit>().selectSpray(index, chosenSpray);
                                  }
                                },
                                child: AnimatedContainer(
                                  duration: const Duration(milliseconds: 200),
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(Dimens.s8),
                                    border: Border.all(
                                      color: selectedSpray != null ? Colors.green : Colors.grey[700]!,
                    ...
                    child: BlocBuilder<CollectionCubit, CollectionState>(
                      builder: (context, state) {
                        return state.maybeWhen(
                          loaded: (_, __, ___, selectedWeaponSkins, ____, _____) {
